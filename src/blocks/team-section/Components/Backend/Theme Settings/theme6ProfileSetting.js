...
const theme6ProfileSetting = (props) => {
  ...
  const { name, title, photo, social = [], paddingTop } = members[index];
    ...
    <>
      ...
      {selectedSocial !== null && social[selectedSocial] && (
        ...
        >
          ...
          <Label className="mb5 mt10">
            {__("Change Icon:", "team-section")}
          </Label>
          <IconControl
      ...
      <UnitControl
        ...
        unit="px"
        className="mt15"
        label={__("Translate(Y)", "team-section")}
        onChange={(value) =>
          setAttributes({
            members: updateData(members, value, index, "paddingTop"),
          })
        }
        value={paddingTop}
      />
...
export default theme6ProfileSetting;

...
const dashboardInfo = info => {
  ...
  return {
    ...
    changelogs: [{
      ...
      version: '2.0.1',
      type: "update",
      list: ['Fixed: Button link sanitization issue.']
    }, {
      version: '2.0.0',
      type: "update",
      list: ['Universal Shortcodes: Compatible with all page builders', '11+ ready-made themes.']
    }],
    proFeatures: ["Universal Shortcodes – Works with all page builders", "Includes 11+ ready-to-use templates", "Multiple Team Layouts – Modern and creative designs", "Fully Responsive – Looks great on all devices", "Member Styling – Customize photo, name, title, and bio", "Typography & Color Controls – Full text and color customization", "Photo Effects – Size, filter, and hover effects", "Social Icons – Add and style social media links", "Element Visibility – Show or hide any member content", "Hover Effects & Animations – Smooth interactive effects", "Layout Controls – Width, alignment, spacing options", "Theme-Specific Features – Shapes, serials, stats, and more", "Beginner Friendly – No coding required"],
    startButton: {
      label: "Start Now",
